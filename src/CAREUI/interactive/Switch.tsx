        ...
        return (
          <li
            ...
            className={classNames(
              ...
              props.selected === tab
                ? "border-accent-500 bg-accent-500 font-semibold text-white hover:bg-accent-600 focus:border-accent-500 focus:ring-accent-500"
                : "border-gray-400 bg-gray-50 hover:bg-gray-200 focus:border-accent-500 focus:ring-accent-500",
            )}
