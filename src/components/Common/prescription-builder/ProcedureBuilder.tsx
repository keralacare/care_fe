              ...
              <div className="flex w-full flex-1 flex-col gap-2">
                ...
                <div className="w-full">
                  ...
                  <input
                    id="procedure-name"
                    type="text"
                    className="mt-1 block w-full rounded border border-gray-400 bg-gray-100 px-4 py-2 text-sm hover:bg-gray-200 focus:border-accent-500 focus:bg-primary focus:outline-none focus:ring-accent-500"
                ...
                <div className="w-full">
                  ...
                  <input
                    type="text"
                    className="block w-full rounded border border-gray-400 bg-gray-100 px-4 py-2 text-sm hover:bg-gray-200 focus:border-accent-500 focus:bg-primary focus:outline-none focus:ring-accent-500"
                    placeholder="Notes"
