...
const OptionChip = (props: { name?: string; value: string }) => {
  return (
    <div className="mt-1 flex h-fit max-w-fit gap-1 whitespace-nowrap rounded-full border border-gray-400 bg-gray-100 px-2 text-center text-xs uppercase sm:mt-0">
