    ...
    <>
      ...
      <tr
        className={classNames(
          ...
          loading ? "bg-gray-300" : "bg-primary hover:bg-accent-100",
        )}
        id={props.id}
      >
        <td
          className="bg-gray-white sticky left-0 z-10 cursor-pointer bg-primary py-3 pl-4 text-left transition-all duration-200 ease-in-out group-hover:bg-accent-100"
