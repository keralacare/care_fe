...
export default function AdministrationEventSeperator({ date }: { date: Date }) {
  ...
  if (date.getHours() === 0) {
    return (
      <div className="mx-auto flex h-[58px] w-10 flex-col items-center justify-center bg-gray-50 text-center text-xs font-bold text-primary-700 transition-all duration-200 ease-in-out group-hover:bg-accent-500 group-hover:text-white">
