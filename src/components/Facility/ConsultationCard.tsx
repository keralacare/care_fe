...
export const ConsultationCard = (props: ConsultationProps) => {
  ...
  return (
    <>
      ...
      <div className="mt-4 block cursor-pointer rounded-lg border bg-primary p-4 text-primary-950 shadow hover:border-accent-500">
        {itemData.is_kasp && (
        ...
        <div className="mt-8 flex flex-col">
          {
            <div className="flex flex-col items-center text-sm text-gray-700 md:flex-row">
              ...
              <div className="ml-1 text-primary-950">
