...
const ConsultationDoctorNotes = (props: ConsultationDoctorNotesProps) => {
  ...
  return (
    ...
    >
      <div className="relative mx-3 my-2 flex grow flex-col overflow-hidden rounded-lg border border-gray-300 bg-primary p-2 sm:mx-10 sm:my-5 sm:p-5">
            ...
            <button
              ...
              className={classNames(
                ...
                thread === PATIENT_NOTES_THREADS[current]
                  ? "border-accent-500 font-bold text-gray-800"
