    ...
    inventoryItem = (
      <>
        <div className="-mx-4 p-4 sm:-mx-8 sm:px-8">
          <div className="hidden min-w-full bg-primary sm:inline-block">
            <table className="min-w-full overflow-hidden rounded-lg leading-normal shadow">
              <thead>
                <tr>
                  <th className="border-b-2 border-gray-200 bg-accent-500 px-5 py-3 text-left text-xs font-semibold uppercase tracking-wider text-white">
                    Item
                  </th>
                  <th className="border-b-2 border-gray-200 bg-accent-500 px-5 py-3 text-left text-xs font-semibold uppercase tracking-wider text-white">
                    Minimum Quantity
                  </th>
                  <th className="border-b-2 border-gray-200 bg-accent-500 px-5 py-3 text-left text-xs font-semibold uppercase tracking-wider text-white"></th>
                </tr>
              </thead>
